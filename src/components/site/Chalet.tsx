      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="chalet-cards mt-10 grid gap-4 md:mt-12 md:grid-cols-3 md:gap-6 lg:mt-14">
          {experiences.map((e) => (
            <div
              key={e.title}
              className="chalet-card scroll-premium-card group relative overflow-hidden rounded-sm border border-gold/15 bg-card/45 px-5 py-4 backdrop-blur-sm transition-[border-color,box-shadow,background-color] duration-500 will-change-transform md:px-6 md:py-5 hover:border-gold/35"
            >
